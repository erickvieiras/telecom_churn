...
with tab4:
    ...
    df_Internet_cities_churn = Internet_cities_churn.loc[:,['city', 'internet_type', 'churn']].groupby([['city', 'internet_type']]).count().sort_values(['churn'], ascending = False).reset_index().head(5)
